...
-- 怪物
monsters = {
    { config_id = 413003, monster_id = 28061501, pos = { x = -1467.586, y = 51.095, z = 5201.302 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, drop_tag = "鸟类", pose_id = 1, area_id = 32 },
	{ config_id = 413004, monster_id = 28061501, pos = { x = -1469.823, y = 52.825, z = 5195.705 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, drop_tag = "鸟类", pose_id = 1, area_id = 32 },
	{ config_id = 413005, monster_id = 28061501, pos = { x = -1469.065, y = 50.68, z = 5207.509 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, drop_tag = "鸟类", pose_id = 1, area_id = 32 }
}
