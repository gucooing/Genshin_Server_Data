...
-- 怪物
monsters = {
	{ config_id = 745001, monster_id = 26100401, pos = { x = -1166.178, y = 103.508, z = 5053.284 }, rot = { x = 0.000, y = 223.067, z = 0.000 }, level = 32, drop_tag = "高级镀金旅团", disableWander = true, pose_id = 1, area_id = 32 },
	{ config_id = 745004, monster_id = 28060401, pos = { x = -1165.217, y = 103.696, z = 5048.204 }, rot = { x = 0.000, y = 288.355, z = 0.000 }, level = 32, drop_tag = "走兽", pose_id = 1, area_id = 32 },
	{ config_id = 745005, monster_id = 28060401, pos = { x = -1168.429, y = 102.569, z = 5055.512 }, rot = { x = 0.000, y = 219.979, z = 0.000 }, level = 32, drop_tag = "走兽", pose_id = 1, area_id = 32 }
}
