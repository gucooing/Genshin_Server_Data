...
monsters = {
	...
	-- 盘旋
	{ config_id = 228007, monster_id = 28060301, pos = { x = -293.981, y = -1.981, z = 4620.079 }, rot = { x = 0.000, y = 43.643, z = 0.000 }, level = 32, drop_tag = "鸟类", disableWander = true, pose_id = 131, area_id = 32},
	...
	{ config_id = 228009, monster_id = 28060301, pos = { x = -189.235, y = -47.205, z = 4848.508 }, rot = { x = 0.000, y = 100.138, z = 0.000 }, level = 32, drop_tag = "鸟类", disableWander = true, pose_id = 131, area_id = 32},
	{ config_id = 228010, monster_id = 28060301, pos = { x = -144.741, y = 1.012, z = 4912.479 }, rot = { x = 0.000, y = 20.807, z = 0.000 }, level = 32, drop_tag = "鸟类", disableWander = true, pose_id = 131, area_id = 32}
}
