...
-- 怪物
monsters = {
	{ config_id = 182001, monster_id = 24040101, pos = { x = -283.856, y = -16.475, z = 4759.913 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, drop_tag = "元能构装体", pose_id = 1004, area_id = 32 },
	{ config_id = 182002, monster_id = 24040201, pos = { x = -280.682, y = -16.688, z = 4765.476 }, rot = { x = 0.000, y = 311.097, z = 0.000 }, level = 32, drop_tag = "元能构装体", pose_id = 1004, area_id = 32 }
}
