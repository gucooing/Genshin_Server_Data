...
-- 装置
gadgets = {
    { config_id = 5001, gadget_id = 70290610, pos = { x = -290.574, y = -163.195, z = 5461.65 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, persistent = true, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE, area_id = 32 }
}
