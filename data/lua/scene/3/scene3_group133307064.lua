...
-- 装置
gadgets = {
    { config_id = 64001, gadget_id = 70330278, pos = { x = -1305.473, y = -27.63, z = 5578.445 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, persistent = true, area_id = 32 },
	{ config_id = 64002, gadget_id = 70330278, pos = { x = -1311.226, y = -27.681, z = 5558.383 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, persistent = true, area_id = 32 }
}
