...
monsters = {
	...
	{ config_id = 262004, monster_id = 28060301, pos = { x = -141.446, y = 322.524, z = 4234.080 }, rot = { x = 0.000, y = 56.917, z = 0.000 }, level = 32, drop_tag = "鸟类", disableWander = true, pose_id = 131, area_id = 32},
	{ config_id = 262005, monster_id = 28060301, pos = { x = -125.667, y = 327.542, z = 4260.814 }, rot = { x = 0.000, y = 258.545, z = 0.000 }, level = 32, drop_tag = "鸟类", disableWander = true, pose_id = 131, area_id = 32}
}
