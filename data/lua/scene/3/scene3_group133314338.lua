...
monsters = {
	...
	{ config_id = 338004, monster_id = 28060502, pos = { x = -687.585, y = 52, z = 4469.699 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, drop_tag = "走兽", pose_id = 1, area_id = 32 }
}
...
suites = {
	-- suite_id = 1,
	-- description = ,
	monsters = { 338002, 338001, 338003, 338004 },
	gadgets = {  },
	regions = { },
	triggers = { },
	rand_weight = 100
