...
-- 怪物
monsters = {
	[1004] = { config_id = 1004, monster_id = 24040301, pos = { x = 327.618, y = 155.045, z = 368.333 }, rot = { x = 0.000, y = 252.16, z = 0.000 }, level = 1, disableWander = true, pose_id = 1 },
	[1006] = { config_id = 1006, monster_id = 24040201, pos = { x = 324.808, y = 155.051, z = 361.761 }, rot = { x = 0.000, y = 293.695, z = 0.000 }, level = 1, disableWander = true, pose_id = 1 },
...
function action_EVENT_SELECT_OPTION_1005(context, evt)
	-- 删除指定group： 240064001 ；指定config：1019；物件身上指定option：175；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 240064001, 1019, 175) then
